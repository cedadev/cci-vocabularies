...
from settings import ONTOLOGIES, SPARQL_HOST_NAME, SPARQL_DATASET, \
    HTML_DIRECTORY, ONTOLOGY_MAP, SPARQL_GRAPH, SPARQL_QUERY
...
def do_stuff(ontology_name):
    ...
    if found_properties:
        ...
        HELPER.write_entities(ontology_name, properties, 'objectproperties',
                              'Object Properties')
        FILE.write('</div>\n')
    ...
    HELPER.write_entities(ontology_name, concepts,
                          'namedIndividuals', 'Named Individuals')
...
def generate():
    for ontology in ONTOLOGIES:
        ...
        file_name = os.path.join(HTML_DIRECTORY, 'ontology', ontology,
                                 ontology + '-content', 'index.html')
